                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        ...
                        <input type="text" name="lName" id="lName" class="validate" placeholder="John" min="2" max="50"
                            maxlength="50" pattern="[a-zA-Zéèêëiîïôöüäç]{1,22}[-]?[a-zA-Zéèêëiîïôöüäç]{1,22}" autofocus
                            required>
                    ...
                    <div class="input-field col s6">
                        <input type="text" name="fName" id="fName" class="validate" placeholder="Doe" min="2" max="50"
                            maxlength="50" pattern="[a-zA-Zéèêëiîïôöüäç]{1,22}[-]?[a-zA-Zéèêëiîïôöüäç]{1,22}" required>
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input type="text" name="country" id="country" class="validate" placeholder="France" min="2"
                            max="50" maxlength="50" pattern="[a-zA-Zéèêëiîïôöüäç]{1,22}[-]?[a-zA-Zéèêëiîïôöüäç]{1,22}"
                            autofocus required>
                    ...
                    <div class="input-field col s6">
                        ...
                        <input type="text" name="nationality" id="nationality" class="validate" placeholder="Française"
                            min="2" max="50" maxlength="50"
                            pattern="[a-zA-Zéèêëiîïôöüäç]{1,22}[-]?[a-zA-Zéèêëiîïôöüäç]{1,22}" autofocus required>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <input type="email" name="email" id="email" class="validate" placeholder="johnDoe@mail.com"
                            min="4" max="50" pattern="[a-zA-Zéèêëiîïôöüäç]{1,22}[-]?[a-zA-Zéèêëiîïôöüäç]{1,22}"
                            autofocus required>
